...
enum ECAITheme {
    ...
    // Stores the primary darker metallic gold colour.
    static let metallicGold = Color(red: 0.78, green: 0.61, blue: 0.16)
    ...
    // Creates the darker metallic gold gradient used for application titles.
    static let goldMetal = LinearGradient(
        colors: [
            Color(red: 0.90, green: 0.76, blue: 0.32),
            Color(red: 0.78, green: 0.61, blue: 0.16),
            Color(red: 0.88, green: 0.70, blue: 0.22)
        ],
        startPoint: .topLeading,
        endPoint: .bottomTrailing
    )
}
// Displays reusable metallic gold title text with a solid black outline.
struct ECAIMetallicTitle: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            outlinedCopy(x: outlineWidth, y: outlineWidth)
            // Displays the finished darker metallic gold title.
            baseText
                .foregroundStyle(ECAITheme.goldMetal)
                .shadow(
    ...
    var body: some View {
        ...
        HStack(spacing: 14) {
            ...
            Image("ECAI-Logo-#1")
                ...
                .shadow(
                    color: ECAITheme.metallicOrange.opacity(0.35),
                    radius: 10
                )
            // Places the title and subtitle vertically.
            VStack(alignment: .center, spacing: 4) {
                // Displays the official darker metallic gold title.
                ECAIMetallicTitle(
                ...
                Text(subtitle)
                    ...
                    .tracking(1.4)
                    // Applies the darker metallic gold colour.
        ...
        .shadow(
            color: ECAITheme.metallicOrange.opacity(0.22),
            radius: 10
        )
    }
}
