    ...
    var body: some View {
        ...
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                ECAIMetallicTitle(text: title.uppercased(), size: 27)
                    // Limits the title to two lines.
                    .lineLimit(2)
                    // Allows the title to shrink when needed.
                    .minimumScaleFactor(0.68)
                // Displays the subtitle below the title.
                Text(subtitle)
                    // Applies the subtitle font.
                    .font(.subheadline.weight(.semibold))
                    // Applies the official silver colour.
                    .foregroundStyle(ECAITheme.silver)
            }
